...
<body style="font-family: 'Poppins', Courier, monospace;">
    <div class="container">
        <h3 style="text-align: center;" class="m-5">Form Regist Data Science</h3>
        <form method="POST" action="form_register.php" class="form-horizontal w-75 mt-5 mx-auto p-4 border shadow-sm">
            ...
            <div class="form-group row">
                <label class="col-4 col-form-label" for="studi">Program Studi</label>
                <div class="col-8">
            ...
            <div class="form-group row">
                <label class="col-4 col-form-label" for="domisili">Domisili</label>
                <div class="col-8">
        ...
        <?php
//ambil data yang di inputkan berdasarkan unique name
//gunakan fungsi isset untuk memeriksa apakah suatu variabel sudah di ataur atau belum
...
echo ' <div style="margin-left: 140px; margin-top: 50px; margin-bottom: 50px;">';
...
echo "<br/>Predikat : ".predikat($nilai);
